...
// STORY MODEL BASED ROUTES

// REQUIRING STORY ROUTES HANDLER
const storyRouteHandler = require("./routes/Story Routes");
application.use('/stories', storyRouteHandler);

// CROP MODEL BASED ROUTES

// REQUIRING CROP ROUTES HANDLER
const cropRouteHandler = require("./routes/Crop Routes");
application.use('/crops', cropRouteHandler);
...
// COMMENT MODEL BASED ROUTES

// REQUIRING COMMENT ROUTES HANDLER
const commentRouteHandler = require("./routes/Comment Routes");
application.use('/stories/:storyId/comments', commentRouteHandler);

// OTHER ROUTES

// HOME ROUTE

// IF NOT LOGGED IN (CLIENT SIDE AUTH)
application.get('/', (req, res) => {
    res.render('users/Login-Signup Page');
});

// IF LOGGED IN (CLIENT SIDE AUTH)
...
function handleApplicationErrors(error, request, response, next) {
    ...
    response.status(error.statusCode).render('Error Page', { title: error.title, error });
}
